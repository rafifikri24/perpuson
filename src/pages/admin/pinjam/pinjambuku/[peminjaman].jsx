...
const Peminjaman = () =>{
    ...
    useEffect(()=>{
        const fetchData = async()=>{
            try{
                const response = await axios.get(`https://perpus-smk-delta.vercel.app/tampil/book/${peminjaman}`)
                setKode(response.data[0].kode_buku)
            ...
            <AdminLayout>
                <div className="p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div class="mb-3">
                            <label for="No" class="form-label">Kode Transaksi Buku</label>
                        ...
                        <div class="mb-3">
                            <label for="Prodi" class="form-label">Tanggal Pinjam <p><small>(Bulan / Tanggal / Tahun)</small></p></label>
                        ...
                        <div class="mb-3">
                            <label for="Prodi" class="form-label">Tanggal Kembali <p><small>(Bulan / Tanggal / Tahun)</small></p></label>
